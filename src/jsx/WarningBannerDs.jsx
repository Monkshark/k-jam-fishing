    ...
    render() {
        return (
            <div>
                <header>
                    <div id="banner">
                        <h1 className="warning">WARNING<br/>
                            <span className="title">귀하의 IP주소가 신고되었습니다!</span>
                        </h1>
                    </div>
                ...
                <div>
                        ...
                        <div>
                            ...
                            <article className="script">
                                <p style={{height:'100%', width: '100%'}}>방금 전 귀하의 IP주소에서
                                    <span className="underscore">불법•유해사이트로의 접근 시도</span>가 확인되었습니다. 즉시 해당 IP주소의 신고가 KICS(대한민국정보통신보안국)에 접수되었음을 알립니다. 이하 법률에 대한 위반사항이 있다면 해당 행위는 위법 행위입니다.
                                </p>
                    ...
                    <div id="section-right">
                        <img src={process.env.PUBLIC_URL + '/res/map-example.png'} alt="loading" width="90%" height="50%" className="margin"/>
